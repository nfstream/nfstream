...
class WFPlugin(NFPlugin):
    ...
    def on_expire(self, flow):
        ...
        self.add_attr_as_list(flow, f_p_k, "f_p_k")
        self.add_attr_as_list(flow, f_u_k, "f_u_k")
        self.add_attr_as_list(flow, f_sigma_k, "f_sigma_k")
        self.add_attr_as_list(flow, f_S_k, "f_S_k")

        b_p_k, b_u_k, b_sigma_k, b_S_k = self.calculate_wavelet_features(
            data=flow.udps.backward, level=self.levels
        )
        self.add_attr_as_list(flow, b_p_k, "b_p_k")
        self.add_attr_as_list(flow, b_u_k, "b_u_k")
        self.add_attr_as_list(flow, b_sigma_k, "b_sigma_k")
        self.add_attr_as_list(flow, b_S_k, "b_S_k")
    ...
    @staticmethod
    def add_attr_as_list(flow, values, attr):
    ...
    def calculate_wavelet_features(
        ...
        Returns:
            ...
            - Relative wavelet energy vector,
            - Absolute mean of detail coefficients,
            - Std. deviation of detail coefficients,
            - Shannon entropy
