...
cd ..
gcc -I/tmp/nfstream_build/mingw64/include/ndpi/ -ID:/a/_temp/msys64/mingw64/include/ -shared -o engine_cc.dll -g -fPIC -DPIC -O2 -Wall engine_cc.c -lwpcap /tmp/nfstream_build/mingw64/lib/libndpi.a /tmp/nfstream_build/mingw64/lib/libgcrypt.a /tmp/nfstream_build/mingw64/lib/libgpg-error.a D:/a/_temp/msys64/mingw64/lib/libws2_32.a
