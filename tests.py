...
ground_truth_ndpi = {'ajp.pcap': {'AJP': 4446},
                     ...
                     'nintendo.pcap': {'Amazon': 2216, 'DNS.Nintendo': 1550, 'ICMP': 2100, 'Nintendo': 302876,
                                       'Nintendo.Amazon': 354, 'TLS.Amazon': 8595, 'TLS.Nintendo': 15462},
                     'BGP_redist.pcap': {'BGP': 322},
                     'ssdp-m-search.pcap': {'SSDP': 1197},
                     'ssh.pcap': {'SSH': 35546},
                     'rx.pcap': {'RX': 26475},
                     'whatsapp_login_call.pcap': {'ApplePush.Apple': 5926, 'DHCP': 3420, 'DNS.Apple': 330,
                     ...
                     'tor.pcap': {'DHCPV6': 906, 'Dropbox': 1860, 'NetBIOS': 252, 'TLS': 12580, 'TLS.Tor': 1513278,
                                  'Tor': 1488564},
                     ...
                     'anyconnect-vpn.pcap': {'AJP': 390, 'ApplePush.Apple': 359, 'CiscoVPN': 4378, 'DNS': 3655,
                     ...
                     'skype_no_unknown.pcap': {'ApplePush.Apple': 1118, 'DNS': 267, 'DNS.Skype': 11566, 'Dropbox': 4352,
                     ...
                     'whatsapp_login_chat.pcap': {'ApplePush.Apple': 2095, 'DHCP': 2052, 'DNS.WhatsApp': 280, 'Dropbox': 1088,
                     ...
                     'malware.pcap': {'DNS': 216, 'HTTP': 66, 'HTTP.OpenDNS': 481, 'ICMP': 98, 'TLS.OpenDNS': 7140},
                     ...
                     'skype.pcap': {'ApplePush.Apple': 1877, 'DNS': 267, 'DNS.AppleiCloud': 234, 'DNS.Skype': 15864,
                                    'Dropbox': 11968, 'ICMP': 656, 'IGMP': 258, 'MDNS': 1736, 'NTP.Apple': 180,
                     ...
                     'zoom.pcap': {'DHCP': 321, 'DNS': 205, 'DNS.Zoom': 838, 'HTTP.Google': 952, 'ICMP': 70,
                                   'ICMP.Zoom': 140, 'IMAPS': 226, 'MDNS': 87, 'NetBIOS': 330, 'SSDP': 168,
                                   'STUN.Zoom': 1440, 'Spotify': 86, 'TLS': 114, 'TLS.Google': 7899, 'TLS.Zoom': 158195,
