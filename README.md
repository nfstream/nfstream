...
<img align="right" src="https://github.com/aouinizied/nfstream/blob/master/docs/source/asset/logo_main.png" width="140" height="122"> 
...
* **Layer-7 visibility:** **nfstream** deep packet inspection engine is based on [**nDPI**][ndpi]. It allows nfstream to perform [**reliable**][reliable] encrypted applications identification and metadata extraction (e.g. TLS, SSH, DNS, HTTP).
